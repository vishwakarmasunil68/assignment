...
//        $html_content="<p>Generating PDF</p>";
//        $pdf = new Html2pdf_lib();
//        $pdf->converHtml2pdf($html_content);
//        $pdf->AddPage();
...
//        $pdf->Output();
    ...
    public function createPDF(){
        ...
        if($userData&&$businessData&&$employeeData&&$hofData){
            ...
            $question1 = $NatureBusi .':'.$AnswerNatureBusi;        //3rd Step      company structered
            ...
            $AnswerbusinessIncKM = isset($data['checkkm']) ? $data['checkkm'] : null;
            ...
            $annualIncomes=$AnswerAnn*100000*20-$totalsaving;
        ...
        $basePath='http://localhost/pdf/';
            ...
            if ($AnswerRollemp == '10' && ($AnswerNatureBusi == 'partnership' || ($AnswerkeyPeople != '0' && $AnswerEmployee == 'Significant impact and business is disrupted') || ($loanTake != 'No' && $AnswerCurrentOut != '0'))) {
                $content .= '<col style="width: 33.33%"/>    <col style="width: 33.33%"/>    <col style="width: 33.33%"/>';
            } elseif ($AnswerRollemp != '10' && ($AnswerNatureBusi != 'partnership' && ($AnswerkeyPeople == '0' && $AnswerEmployee != 'Significant impact and business is disrupted') && ($loanTake == 'No'))) {
                $content .= '<col style="width: 33.33%"/>    <col style="width: 33.33%"/>    <col style="width: 33.33%"/>';
            } elseif ($AnswerRollemp == '10' && ($AnswerNatureBusi != 'partnership' && ($AnswerkeyPeople == '0' && $AnswerEmployee != 'Significant impact and business is disrupted') && ($loanTake == 'No'))) {
            ...
            $content .= ' <div style="text-align: center"> <h2><b>Aviva SME Assist Tool Analysis Report for ' . $clientName_long . '</b></h2> </div>  ';
            $content .= '</td> </tr>';
            $content .= '<tr class="center" align="center"> <td colspan="4">';
            ...
            if ($AnswerRollemp == '10' && ($AnswerNatureBusi == 'partnership' || ($AnswerkeyPeople != '0' && $AnswerEmployee == 'Significant impact and business is disrupted') || ($loanTake != 'No' && $AnswerCurrentOut != '0'))) {
                ...
                $content .= '<td class="fcolor" style="background:#422767;padding:10px 0;">Family</td>';
            } elseif ($AnswerRollemp != '10' && ($AnswerNatureBusi != 'partnership' && ($AnswerEmployee != 'Significant impact and business is disrupted') && ($loanTake == 'No'))) {
                // $content .= '<td class="fcolor" style="background:#0b8a44;padding:10px 0;">Statutory</td>';
                $content .= '<td class="fcolor" style="background:#07529a;padding:10px 0;;text-align:center;vertical-align:middle;">Employer </td>';
                $content .= '<td class="fcolor" style="background:#422767;padding:10px 0;">Family</td>';
            } elseif ($AnswerRollemp == '10' && ($AnswerNatureBusi != 'partnership' && ($AnswerEmployee != 'Significant impact and business is disrupted' || $AnswerkeyPeople == '0') && ($loanTake == 'No'))) {
                $content .= '<td class="fcolor" style="background:#07529a;padding:10px 0;;text-align:center;vertical-align:middle;">Employer </td>';
                $content .= '<td class="fcolor" style="background:#422767;padding:10px 0;">Family</td>';
            } else {
                // $content .= '<td class="fcolor" style="background:#0b8a44;padding:10px 0px 10px 20px;text-align:left;">Statutory</td>';
                $content .= '<td class="fcolor" colspan="1" style="background:#b81e78;padding:10px 0px 10px 20px;margin:0;text-align:center;">Business</td>';
                $content .= '<td class="fcolor" colspan="2" style="background:#07529a;padding:10px 0px 10px 20px;text-align:center;vertical-align:middle;text-align:center;">Employer </td>';
                $content .= '<td class="fcolor" colspan="2" style="background:#422767;padding:10px 0px 10px 20px;text-align:center;">Family</td>';
            }
            ...
            //Business
            if ($AnswerNatureBusi == 'partnership' || ($AnswerkeyPeople != '0' && $AnswerEmployee == 'Significant impact and business is disrupted') || ($loanTake != 'No')) {
                $content .= '<td class="paddingClass" colspan="1" style="text-align:center;">';
                ...
                if ($AnswerkeyPeople != '0' && $AnswerEmployee == 'Significant impact and business is disrupted') {
            ...
            //Employer
            $content .= '<td class="paddingClass" colspan="2" style="text-align:center;">';
            ...
            if (($AnswerNatureBusi == 'partnership' && $AnswerbusinessIncPI != 'Partnership Insurance') || ($AnswerkeyPeople != '0' && $AnswerbusinessIncKM != 'Key Man' && $AnswerEmployee == 'Significant impact and business is disrupted') || ($loanTake != 'No' && $AnswerCurrentOut > 0)) {
                $content .= '<table class="table">';
                $content .= '<col style="width: 25%"/>    <col style="width: 25%"/>    <col style="width: 25%"/> <col style="width: 25%"/>';
                $content .= '<thead>';
                ...
                if ($AnswerbusinessIncPI == 'Partnership Insurance') {
                    ...
                    //    if(($AnswerNatureBusi=='partnership' && $AnswerbusinessIncKM!='Key Man') && ($AnswerkeyPeople != '0' && $AnswerEmployee=='Significant impact and business is disrupted'))
                ...
                if ($AnswerkeyPeople != '0' && $AnswerbusinessIncKM != 'Key Man' && $AnswerEmployee == 'Significant impact and business is disrupted' && $loanTake != 'No' && $AnswerCurrentOut != '0') {
                    $colKey = '2';
                } else {
                    $colKey = '4';
                }
                ...
                $content .= '<tr class="withBorder majentaColor">';
                if ($AnswerkeyPeople != '0' && $AnswerbusinessIncKM != 'Key Man' && $AnswerEmployee == 'Significant impact and business is disrupted') {
            ...
            if ($AgeDiff <= $maxAge) {
                if ($AnswerHousehold != 'I am adequately insured; the family will not have significant financial issues') {
                    ...
                    if ($annualIncomes <= '2000000') {
                        ...
                        $content .= '<p>Basis your family and business situation we recommend a term cover of Rs.25,00,000, For Prermium of Rs.' . $this->money_format('%!.0n', $rebatepremiumon25) . ' Yearly.</p>';
            ...
            $savingsvalue = $AnswerAnn * 10000;
            if ($savingsvalue < 100000) {
                $savedrs = $this->money_format('%!.0n', $savingsvalue);
            } else {
...
//            $pdf->Output();
           ...
           // $this->pdf->render();
           // // $this->pdf->stream("save_pdf.pdf", array("Attachment"=>1));
           // $pdf_content = $this->pdf->output();
           //  file_put_contents('ordine.pdf',$pdf_content);
...
// $document->render();
// $document->stream('report', array('Attachment'=>1));
