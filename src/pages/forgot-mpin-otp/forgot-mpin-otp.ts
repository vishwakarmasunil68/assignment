...
import {ValidateForgotMpinOtpPage} from "../validate-forgot-mpin-otp/validate-forgot-mpin-otp";

/**
 * Generated class for the ForgotMpinOtpPage page.
 *
...
export class ForgotMpinOtpPage {
  ...
  callAPI(): void {
    if (this.phone != '') {
      ...
      var url = Constants.FORGOT_MPIIN;
      ...
      postdata.append('mobile', "+91" + Constants.replaceStringContent(this.phone, "+91", ""));
      ...
      this.http.post(url, postdata).subscribe(result => {
        ...
        try {
          ...
          if (parsedData.status == "success") {
            ...
            window.localStorage.setItem(Constants.FORGOT_MOBILE, "+91" + Constants.replaceStringContent(this.phone, "+91", ""));
            this.navCtrl.push(ValidateForgotMpinOtpPage);
          } else {
            this.presentToast(parsedData.message);
          }
        } catch (err) {
