...
export class ProfilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private androidPermissions: AndroidPermissions,
              ...
              private events: Events,private filePath:FilePath,private appMessage:AppMessageProvider) {
      ...
      .then((data) => {
        ...
        if (data.responseCode == 200) {
          ...
          if (parsedJSON.status == "success") {
            window.localStorage.setItem(Constants.USER_LOGIN_DATA, data.response);
            ...
            // this.events.publish('set_profile', 'set_profile');
            this.appMessage.sendMessage('set_profile');
          } else {
