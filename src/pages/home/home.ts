...
import {MessageToRootProvider} from '../../providers/message-to-root/message-to-root';
import {AppMessageProvider} from "../../providers/app-message/app-message";
...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public menuCtrl: MenuController, public events: Events,
              public viewCtrl: ViewController, public http: HttpClient, public alertCtrl: AlertController,
              private messageService: MessageProvider, private rootMessage: MessageToRootProvider,private appMessageProvider:AppMessageProvider) {
  ...
  ionViewWillEnter() {
    this.appMessageProvider.sendMessage("");
    this.rootSubscription = this.rootMessage.getMessage().subscribe(message => {
      //console.log("message:-" + message.tab_clicked);
      switch (message.tab_clicked) {
        case "open_menu":
          this.openMenu();
          break;
        case "profile":
  ...
  ionViewDidLeave() {
    ...
    this.events.unsubscribe("tab_selection");
