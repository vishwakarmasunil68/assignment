...
export class NewAssignmentPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menuCtrl: MenuController,
              ...
              private fileChooser: FileChooser, private filePath: FilePath, private events: Events, private iosPicker: IOSFilePicker) {
    var d = new Date();
  ...
  submitAssignment() {
    if (this.attached_file_path == "") {
      ...
      this.addMultipartAssignment(encodeURI(this.attached_file_path), currentName);
    }
  }
