...
export class AssignmentListPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public events: Events,
    public loadingCtrl: LoadingController, public toastCtrl: ToastController, public http: HttpClient,
    private rootMessage:MessageToRootProvider) {
  ...
  openMenu(): void {
    ...
    this.rootMessage.sendMessageObj({
      "tab_clicked": "open_menu"
    })
  }
  ...
  getOrderList() {
    ...
    this.http.post(url, postdata).subscribe(result => {
      ...
      console.log("main list length:-"+this.mainOrderList.length);
